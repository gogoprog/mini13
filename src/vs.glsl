...
const vec3 sphereVertices[36] = vec3[36](
    vec3(0.0, -0.5, 0.0),
    vec3(0.4330127, -0.25, 0.0),
    vec3(-0.2165064, -0.25, 0.3750001),
    vec3(-0.2165064, -0.25, -0.3750001),
    vec3(0.2165064, 0.25, 0.3750001),
    vec3(0.2165064, 0.25, -0.3750001),
    vec3(-0.4330127, 0.25, 0.0),
...
const int sphereIndices[72] = int[72](
    0, 1, 2,    0, 2, 3,    0, 3, 1,
    4, 5, 6,    4, 6, 7,    4, 7, 5,
    8, 9, 10,   8, 10, 11,  8, 11, 9,
    12, 13, 14, 12, 14, 15, 12, 15, 13,
    16, 17, 18, 16, 18, 19, 16, 19, 17,
    20, 21, 22, 20, 22, 23, 20, 23, 21,
    24, 25, 26, 24, 26, 27, 24, 27, 25,
    28, 29, 30, 28, 30, 31, 28, 31, 29
);
